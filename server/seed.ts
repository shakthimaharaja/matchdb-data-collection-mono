  ...
  const candidates = [
    {
      ...
      resume_summary:
        "Senior Full Stack Developer with 6+ years of experience building enterprise-grade web applications. Proficient in React, Node.js, and cloud-native architectures.",
      resume_experience:
        "Senior Developer at Salesforce (2021-present): Led the redesign of the Lightning Web Components platform.\nFull Stack Developer at Twilio (2019-2021): Built real-time communication dashboards using React and WebSockets.",
      resume_education:
        "M.S. Computer Science, Stanford University, 2019\nB.Tech Computer Science, IIT Delhi, 2017",
      resume_achievements:
        "Patent holder for real-time data synchronization algorithm.\nSalesforce Trailblazer of the Year 2023.",
      source: "manual",
    ...
    },
    {
      ...
      resume_summary:
        "Data Engineer with 4 years of experience in building and maintaining petabyte-scale data pipelines on AWS and Databricks.",
      resume_experience:
        "Data Engineer at Databricks (2022-present): Architected ETL pipelines processing 2TB+ daily.\nJunior Data Engineer at Netflix (2020-2022): Built content recommendation data infrastructure.",
      resume_education:
        "B.S. Data Science, University of Texas at Austin, 2020",
      resume_achievements:
        "Reduced data pipeline latency by 70% through Spark optimization.\nAWS Certified Data Analytics Specialty.",
      source: "paste",
      uploaded_by: candidateUser._id,
    },
    {
      ...
      resume_summary:
        "Frontend Developer with 3 years of experience across React, Vue, and Angular ecosystems. Strong design sensibility with Figma proficiency.",
      resume_experience:
        "Freelance Frontend Developer (2023-present): Built 8+ client projects including e-commerce, SaaS dashboards, and web apps.\nUI Developer at Zillow (2021-2023): Implemented responsive property listing pages used by 10M+ monthly visitors.",
      resume_education:
        "B.A. Interactive Media, University of Washington, 2021",
      resume_achievements:
        "Winner of HackTheNorth 2022 — Best UI/UX category.\nOpen-source Tailwind component library with 2k+ GitHub stars.",
      source: "manual",
      uploaded_by: candidateUser._id,
    },
    {
      ...
      resume_summary:
        "Senior DevOps Engineer with 8 years of experience managing large-scale cloud infrastructure for Fortune 500 companies.",
      resume_experience:
        "Senior DevOps Engineer at HashiCorp (2021-present): Core contributor to Terraform enterprise features.\nDevOps Lead at Capital One (2018-2021): Managed cloud migration for 50+ microservices.\nSystems Engineer at Lockheed Martin (2016-2018): Linux systems administration for mission-critical systems.",
    ...
    },
    {
      ...
      resume_summary:
        "ML Engineer with 5 years of experience in NLP, recommendation systems, and production ML pipelines. Currently at Meta working on content ranking algorithms.",
      resume_experience:
        "ML Engineer at Meta (2022-present): Improved content ranking model accuracy by 15%, impacting 2B+ daily recommendations.\nML Engineer at Spotify (2020-2022): Built podcast recommendation engine using collaborative filtering and transformer models.",
      resume_education:
    ...
    },
    {
      ...
      resume_summary:
        "Backend Engineer with 4 years of experience in Ruby on Rails and Go. Skilled in database optimization and distributed system design.",
      resume_experience:
        "Backend Engineer at Shopify (2022-present): Built checkout optimization service handling 100k+ RPM.\nSoftware Engineer at Uber (2020-2022): Developed rider-matching backend microservices in Go.",
      resume_education:
        "B.S. Computer Science, Florida International University, 2020",
      resume_achievements:
        "Reduced Shopify checkout latency by 40% through Redis caching strategy.\nOpen-source GraphQL middleware with 1.5k+ stars.",
      source: "manual",
      uploaded_by: candidateUser._id,
    },
    {
      ...
      resume_summary:
        "Security Engineer with 7 years of experience in application security, infrastructure hardening, and compliance. Currently securing payments infrastructure at Stripe.",
      resume_experience:
        "Security Engineer at Stripe (2021-present): Led SOC2 Type II compliance initiative.\nSr. Security Analyst at CrowdStrike (2018-2021): Built threat detection pipelines for enterprise clients.",
      resume_education:
        "M.S. Cybersecurity, MIT, 2018\nB.S. Computer Science, UC Berkeley, 2016",
      resume_achievements:
  ...
  const jobs = [
    {
      ...
      description:
        "We are looking for an experienced React developer to lead our frontend architecture. You will work closely with design and backend teams to build a next-generation SaaS dashboard. Must have strong TypeScript skills and experience with state management libraries.",
    ...
    },
    {
      ...
      description:
        "Design and implement cloud infrastructure solutions for enterprise clients. Lead cloud migration projects, define architecture patterns, and mentor junior engineers. Deep AWS expertise required with multi-cloud experience preferred.",
    ...
    },
    {
      ...
      description:
        "Join our analytics team to transform raw data into actionable business insights. Build dashboards, write SQL queries, and present findings to stakeholders. Experience with Tableau or Power BI strongly preferred.",
    ...
    },
    {
      ...
      description:
        "Build and maintain cross-platform mobile applications using React Native. Collaborate with UX designers to implement pixel-perfect interfaces. Experience with native modules and app store deployment required.",
      company: "MobileFirst",
      location: "Austin, TX",
      job_type: "contract",
      job_subtype: "c2h",
    ...
    },
    {
      ...
      description:
        "Join our platform team building core microservices that power the entire product suite. You will design APIs, optimize database performance, and ensure system reliability at scale. Strong distributed systems knowledge required.",
    ...
    },
    {
      ...
      description:
        "Work on cutting-edge NLP models for our AI-powered search platform. Fine-tune large language models, build evaluation pipelines, and deploy models to production. PhD preferred but not required.",
      company: "Cognify AI",
      location: "Boston, MA",
      job_type: "full_time",
      job_subtype: "salary",
    ...
    },
    {
      ...
      description:
        "Ensure platform reliability and build CI/CD infrastructure for a fast-growing fintech startup. On-call rotation required. Experience with incident management and SLO-driven operations preferred.",
      company: "PayStream",
      location: "Chicago, IL",
      job_type: "contract",
      job_subtype: "1099",
    ...
    },
    {
      ...
      description:
        "End-to-end development on our health-tech platform. Build patient-facing features with React and Node.js. HIPAA compliance knowledge is a strong plus. Agile team with 2-week sprints.",
